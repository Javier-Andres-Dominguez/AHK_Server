...
public class SearchPage {
	...
	public void initialize() {
		...
		TreeItem<String> rootItem = new TreeItem<>("Results:", new ImageView(new Image(getClass().getResourceAsStream("folder.png"))));
	...
	private boolean checkBoxes() {
		if(categoriesCheckBox.isSelected() || subcategoriesCheckBox.isSelected() || filesCheckBox.isSelected() || usersCheckBox.isSelected()) {
			return true;
		}else {
			return false;
		}
